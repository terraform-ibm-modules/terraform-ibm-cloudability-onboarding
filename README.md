...
| <a name="input_cloudability_host"></a> [cloudability\_host](#input\_cloudability\_host) | IBM Cloudability hostname which depends on the region where Cloudability is created. See [Cloudability API documentation](https://help.apptio.com/en-us/cloudability/api/v3/getting%20started%20with%20the%20cloudability.htm) | `string` | `"api.cloudability.com"` | no |
