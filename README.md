...
| <a name="input_resource_group_name"></a> [resource\_group\_name](#input\_resource\_group\_name) | The name of a new or existing resource group where resources will be created | `string` | `"cloudability-enablement"` | no |
