...
<!-- BEGIN OVERVIEW HOOK -->
## Overview
* [encrypted_cos_bucket](#encrypted_cos_bucket)
...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_cos_bucket"></a> [cos\_bucket](#module\_cos\_bucket) | terraform-ibm-modules/cos/ibm | 8.6.2 |
| <a name="module_key_protect_all_inclusive"></a> [key\_protect\_all\_inclusive](#module\_key\_protect\_all\_inclusive) | terraform-ibm-modules/kms-all-inclusive/ibm | 4.14.1 |
...
| <a name="input_monitoring_crn"></a> [monitoring\_crn](#input\_monitoring\_crn) | Cloud Monitoring crn for COS bucket (Optional) | `string` | `null` | no |
